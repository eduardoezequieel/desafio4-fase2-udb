...
public class LoanCtrl {
    ...
    public Loan getLoan(int loanId) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                loan.setLoanStateId(rs.getInt("loanStateId"));
                loan.setUserId(rs.getString("userId"));
                loan.setAdminId(rs.getString("adminId"));
                loan.setStartDate(rs.getString("startDate"));
                loan.setEndDate(rs.getString("endDate"));
                loan.setLoanOverdueId(rs.getInt("loanOverdueId"));
            }
    ...
    public List<Material> getMaterialsFromLoan(int loanId) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                material.setInventoryId(rs.getInt("inventoryId"));
                material.setTitle(rs.getString("title"));
                material.setMaterialTypeName(rs.getString("materialTypeName"));
                material.setLibraryName(rs.getString("libraryName"));
