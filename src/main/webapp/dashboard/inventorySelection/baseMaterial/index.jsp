...
<head>
    ...
    <link rel="stylesheet" href="baseMaterial.css">
</head>
<body>
<main>
    ...
    <div class="page-container">
        <div class="inner-container">
            ...
            <a href="/dashboard/inventorySelection/baseMaterial?action=create">
            ...
            <div class="table-container">
                <table class="table table-striped" style="width: 100%" id="material-table">
                    ...
                    %>
                    <tr>
                        <th scope="row"><%= material.getCode() %>
                        </th>
                        <td><%= material.getTitle() %>
                        </td>
                        <td><%= material.getMaterialTypeName() %>
                        </td>
                        <td>
                            <a href="/dashboard/inventorySelection/baseMaterial?action=edit&code=<%=material.getCode()%>">
                                <button class="btn btn-primary btn-sm">Editar</button>
                            </a>
                            <a href="/dashboard/inventorySelection/baseMaterial?action=delete&code=<%=material.getCode()%>">
